...
namespace Sintetizzatore
{
    ...
    {
        /// @brief Strumento musicale con note pure, senza serie armonica o altri effetti, e gli inviluppi delle note
        ...
        class Puro: public StrumentoMusicale
        {
          ...
          public:
            ...
            /// @brief Restituisce il campione audio successivo dello strumento musicale. Il valore del campione è
            /// sempre compreso nell'intervallo [-1, 1].
        ...
        /// @brief Strumento musicale con note pure, senza serie armonica o altri effetti, prodotte usando un'onda
        /// quadra e gli inviluppi delle note sono tutti uguali tra di loro.
        ...
        {
            // Gli 88 tasti del piano forte vanno dalla nota La0 (A0) alla Do8 (C8), i corrispettivi numeri MIDI vanno
            // da 21 a 109.
          ...
          public:
            Pianoforte(): riverbero(0.85, 0.3, 5000.0)
            {
                ...
                // La durata della fase di rilascio e di decadimento diminuisce con l'aumentare della frequenza della
                // nota
            ...
            double Campione() override
            {
                ...
                for (size_t i = 0; i < note.size(); ++i)
                {
                    ...
                    {
                        // Converto l'intervallo di variazione dell'inviluppo nella fase di attacco ([0, 1])
                        // nell'intervallo [1, 1 + IncrementoAmpiezze].
                    ...
                    {
                        // Converto l'intervallo di variazione dell'inviluppo nella fase di decadimento (che corrisponde
                        // a [1, LivelloSostentamento]) nell'intervallo [1, 0].
